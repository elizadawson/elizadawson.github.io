...
<div style="font-size: 0.85em; margin-top: 1em;">
  ...
  <p>
    Radar sounding provides the only continent scale view of the ice sheet subsurface, from internal layering to the ice bed. I develop methods to extract physical information about ice properties including ice temperature and subglacial water from radar datasets. For example, I built a statistical framework to classify <a href="/publications/#publication-2024-Dawson">frozen and thawed bed conditions</a> beneath the Wilkes Subglacial Basin outflow, including confidence for each classification, producing a novel radar based thermal state assessment for a region central to East Antarctica stability. I also derive attenuation constraints from radar echo power that can be compared with borehole, model output, and other geophysical estimates.
  </p>

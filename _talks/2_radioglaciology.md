...
<div style="display: flex; align-items: center; justify-content: space-between; margin-top: 1em;">
  ...
  <div style="flex: 1; font-size: 0.8em;">
    <p>I use geophysical observations, particularly radar sounding, to reveal the physical state of ice sheets from surface to bed. Radar data can capture variations in ice properties and basal thermal and hydrologic conditions, yet quantitative analyses remain uncommon. My work advances these capabilities by applying statistical and machine learning approaches to extract robust physical insight from radar signals.</p>
